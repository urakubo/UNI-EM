...
Caution: currently, UNI-EM cannot run on the newest NVIDIA GPUs, such as A100 and RTX30X0 (in particular, microsoft windows). This is because UNI-EM is based on tensorflow1.X, while the newest GPUs are compatible with tensorflow2.X, but not tensorflow1.X. Please refer to the following website.
