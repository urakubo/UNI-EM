...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateMetricsOnPaintTable", function() { return updateMetricsOnPaintTable; });
...
const updateMetricsOnPaintTable = () => {
  ...
  console.log("updateMetricsOnPaintTable#2", meshes, _APP__WEBPACK_IMPORTED_MODULE_0__["APP"].getMeshes(), activeSurfaces);
...
const SurfaceTable = new Tabulator("#SurfaceTable", {
...
console.log("EventEmitter", events__WEBPACK_IMPORTED_MODULE_3___default.a);
const clientId = crypto__WEBPACK_IMPORTED_MODULE_2___default.a.randomBytes(8).toString("hex");
...
class RoomManager {
  constructor(socket) {
    ...
    this.onUpdateData = data => {
      ...
      console.log((currentData === null || currentData === void 0 ? void 0 : currentData.sid) || this.socket.id, this.socket.id);
